...
│   ├── models/schemas.py    # Pydantic v2 validation contracts (Contracts C & D)
...
│   ├── src/                 # Situational maps, Gantt schedules, Oceanic design system
...
│   └── models/              # Serialized model (.pkl) & feature importance JSON
