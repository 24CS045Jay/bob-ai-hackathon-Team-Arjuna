...
export default function LoginPage() {
  ...
  const roleMeta = {
    admin: {
      ...
      lightBg: 'bg-sky-500/15 text-sky-300 border border-sky-500/30',
      accent: '#0284C7',
      ring: 'ring-[#0284C7]/40',
      tag: 'Full Authority',
    ...
    shift_supervisor: {
      ...
      lightBg: 'bg-amber-500/15 text-amber-300 border border-amber-500/30',
      accent: '#F59E0B',
      ring: 'ring-[#F59E0B]/40',
      tag: 'Ops Lead',
    ...
    berth_planner: {
      ...
      lightBg: 'bg-purple-500/15 text-purple-300 border border-purple-500/30',
      accent: '#7C3AED',
      ring: 'ring-[#7C3AED]/40',
    ...
    gate_controller: {
      ...
      lightBg: 'bg-emerald-500/15 text-emerald-300 border border-emerald-500/30',
      accent: '#10B981',
      ring: 'ring-[#10B981]/40',
      tag: 'Drayage & OCR',
    ...
    viewer: {
      ...
      lightBg: 'bg-slate-500/15 text-slate-300 border border-slate-500/30',
      accent: '#64748B',
